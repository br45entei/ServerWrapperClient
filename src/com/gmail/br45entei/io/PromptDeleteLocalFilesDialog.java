...
public class PromptDeleteLocalFilesDialog extends Dialog {
	 ...
	 * @param parent
	 * @param style */
	public PromptDeleteLocalFilesDialog(Shell parent) {
	...
	private void createContents(String downloadedFilesPath) {
		...
		this.shell.addShellListener(new ShellAdapter() {
			...
			public void shellClosed(ShellEvent e) {
				e.doit = false;
				PromptDeleteLocalFilesDialog.this.result = Response.CLOSE;
			}
		});
		this.shell.setSize(387, 200);
		...
		lblAreYouSure.setBounds(10, 10, 360, 126);
		lblAreYouSure.setText("Would you like to delete the downloaded server files located in the current download directory before resetting it to the default?\r\nCurrent directory is: " + downloadedFilesPath + "\r\n\r\nYes: delete files and reset download directory to default.\r\nNo: Leave files alone and reset download directory.\r\nCancel(escape/close): Do nothing.");
		
		Button btnYes = new Button(this.shell, SWT.NONE);
		btnYes.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				PromptDeleteLocalFilesDialog.this.result = Response.YES;
			}
		});
		btnYes.setBounds(10, 142, 177, 23);
		btnYes.setText("Yes");
		...
		btnNo.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				PromptDeleteLocalFilesDialog.this.result = Response.NO;
			}
		});
		btnNo.setBounds(193, 142, 177, 23);
		btnNo.setText("No");
	}
